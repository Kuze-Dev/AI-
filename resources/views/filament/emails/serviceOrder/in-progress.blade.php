                    ...
                    <center>
                        <div style="max-width: 600px;padding: 20px;">
                            ...
                            <p style="line-height: 1.5em" align="left">
                                We are pleased to inform you that the service, <strong>{{ $serviceOrder->service_name }}</strong>, is now
                                in progress,
                                and our dedicated team is actively working to deliver the desired outcomes
                            </p>
                        </div>
                    </center>
