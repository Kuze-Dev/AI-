...
<div
    ...
    @if (filled($state))
        <div @class([
            'min-h-6 inline-flex items-center justify-center space-x-1 whitespace-nowrap rounded-xl px-4 py-0.5 text-sm font-medium tracking-tight rtl:space-x-reverse',
