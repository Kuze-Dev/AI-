...
abstract class USPSBase
{
    ...
    public const TEST_API_URL = 'http://production.shippingapis.com/ShippingAPITest.dll';
    ...
    /**
     * set the usps api password we are going to user
     *
     * @param string $password - the usps api username
     */
    ...
    protected function doRequest($ch = null)
    {
        ...
        // execute
        $this->setResponse(curl_exec($curlHandle));
        $this->setHeaders(curl_getinfo($curlHandle));

        // fetch errors
        $this->setErrorCode(curl_errno($curlHandle));
        $this->setErrorMessage(curl_error($curlHandle));
    ...
    public function isError()
    {
        ...
        return (bool) (strpos($this->getResponse(), '<Error>') !== false);
