...
return [
    ...
    'key' => app(CMSSettings::class)->googlemap_api_key,
    ...
    'keys' => [
        'web_key'     => env('FILAMENT_GOOGLE_MAPS_WEB_API_KEY', app(CMSSettings::class)->googlemap_api_key),
        'server_key'  => env('FILAMENT_GOOGLE_MAPS_SERVER_API_KEY', app(CMSSettings::class)->googlemap_api_key),
