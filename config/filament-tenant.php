...
return [
    ...
    */
    ...
    'pages' => [
        ...
        'path' => app_path('FilamentTenant/Pages'),
        'register' => [],
    ],
    ...
    */
    ...
    'resources' => [
        ...
        'path' => app_path('FilamentTenant/Resources'),
        'register' => [],
    ],
    ...
    */
    ...
    'widgets' => [
        ...
        'path' => app_path('FilamentTenant/Widgets'),
        'register' => [
    ...
    */
    ...
    'livewire' => [
        'namespace' => 'App\\FilamentTenant',
        'path' => app_path('FilamentTenant'),
    ],
