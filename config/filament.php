...
return [
    ...
    */
    ...
    'domain' => env('FILAMENT_DOMAIN', parse_url(env('APP_URL', ''), PHP_URL_HOST)),
    ...
    */
    ...
    'google_fonts' => 'https://fonts.googleapis.com/css2?family=Source+Sans+3:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&display=swap',
